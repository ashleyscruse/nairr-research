...
Regardless of your entry point, you leave Ideation with a one-page research brief containing:

1. **Research question** (one sentence)
2. **Gap it fills** (what has not been done and why it matters)
3. **Data sources** (specific datasets with names, URLs, and formats)
4. **Target venues** (2-3 conferences or journals with deadlines)

You do not move to Stage 2 until this is complete.
